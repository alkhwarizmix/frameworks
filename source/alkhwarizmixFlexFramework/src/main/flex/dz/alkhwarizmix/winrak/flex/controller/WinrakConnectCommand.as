 ...
 */
public class WinrakConnectCommand extends WinrakBlazeDSGetDataCommand
{
	//--------------------------------------------------------------------------
	//
	//  Constructor
	 ...
	 *  Constructor.
	 */
	public function WinrakConnectCommand()
	{
		super();
	}
	...
	{
		if (!LOG)
			LOG = AlKhwarizmixLog.getLogger(WinrakConnectCommand);
		return LOG;
	}
