 ...
 */
public class WinrakLogoutCommand extends WinrakBlazeDSGetDataCommand
{
	//--------------------------------------------------------------------------
	//
	//  Constructor
	 ...
	 *  Constructor.
	 */
	public function WinrakLogoutCommand()
	{
		super();
	}
	...
	{
		if (!LOG)
			LOG = AlKhwarizmixLog.getLogger(WinrakLogoutCommand);
		return LOG;
	}
