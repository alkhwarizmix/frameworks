 ...
 */
public class WinrakSetCustomizedDataCommand extends WinrakBlazeDSGetDataCommand
{
	//--------------------------------------------------------------------------
	//
	//  Constructor
	 ...
	 *  Constructor.
	 */
	public function WinrakSetCustomizedDataCommand()
	{
		super();
	}
	...
	{
		if (!LOG)
			LOG = AlKhwarizmixLog.getLogger(WinrakSetCustomizedDataCommand);
		return LOG;
	}
