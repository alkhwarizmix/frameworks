 ...
 */
public class AlKhwarizmixSuperProxyTestCase extends TestCase
{
	//--------------------------------------------------------------------------
	//
	//  SETUP & TEARDOWN
	...
	private var classUnderTest:AlKhwarizmixSuperProxy = null;
	...
	public function test01_constructor_should_throwMissingImplError():void
	{
		try
		{
			classUnderTest = new AlKhwarizmixSuperProxy();
