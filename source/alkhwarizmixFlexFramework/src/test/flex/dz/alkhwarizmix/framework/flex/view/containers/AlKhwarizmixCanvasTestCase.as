 ...
 */
public class AlKhwarizmixCanvasTestCase extends AlkhwarizmixUITestCase 
{
	//--------------------------------------------------------------------------
	//
	//  SETUP & TEARDOWN
	...
	private var classUnderTest:AlKhwarizmixCanvas = null;
	...
	{
		classUnderTest = new AlKhwarizmixCanvas();
