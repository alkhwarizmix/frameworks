 ...
 */
public class AlKhwarizmixMDIWindowTestCase extends AlkhwarizmixUITestCase 
{
	//--------------------------------------------------------------------------
	//
	//  SETUP & TEARDOWN
	...
	private var classUnderTest:AlKhwarizmixMDIWindow = null;
	...
	{
		classUnderTest = new AlKhwarizmixMDIWindow();
