 ...
 */
public class AlKhwarizmixVBoxTestCase extends AlkhwarizmixUITestCase 
{
	//--------------------------------------------------------------------------
	//
	//  SETUP & TEARDOWN
	...
	private var classUnderTest:AlKhwarizmixVBox = null;
	...
	{
		classUnderTest = new AlKhwarizmixVBox();
